...
**Studio** — item fields split into Basics + a collapsed "Advanced" fieldset, plain-language labels/descriptions for a non-technical editor. The `anchor` field renders as a clickable 2×3 mini-map of the hero screen ([sanity/components/AnchorMiniMapInput.jsx](sanity/components/AnchorMiniMapInput.jsx)) — the stored value is unchanged. See [.mdd/docs/14-hero-overlay-sizing.md](.mdd/docs/14-hero-overlay-sizing.md) and [13](.mdd/docs/13-hero-overlay-mobile.md).

  ...
  return (
    <div className="flex flex-col items-center w-full">
      ...
      <div className="flex flex-col items-center w-full max-w-[1600px] md:px-[100px]">
        ...
        {/* Phone shows the collapsed bands two-up (unchanged); tablet (md)
            lays them out three-up, and desktop (lg, ≥1024px) goes four-up.
            Same stacked title + subtitle card throughout. An expanded band

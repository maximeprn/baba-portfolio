        ...
        {otherProjects.length > 0 && (
          <>
            ...
            {/* Phone shows the collapsed bands two-up (unchanged); tablet
                and desktop lay them out three-up — the same stacked title +
                subtitle card, just in a 3-column grid. An expanded band
                breaks out to full width via col-span-2 / md:col-span-3 on
                its <article>. */}

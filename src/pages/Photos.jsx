      ...
      <div className="flex flex-col items-center w-full max-w-[1600px] md:px-[100px]">
        ...
        {otherProjects.length > 0 && (
          <>
            ...
            {/* Phone shows the collapsed bands two-up (unchanged); tablet
                lays them out three-up, and from the `cards` breakpoint
                (1350px) — "when the space allows it" — desktop goes
                four-up. Same stacked title + subtitle card throughout. An
                expanded band breaks out to full width via col-span-2 /
                md:col-span-3 / cards:col-span-4 on its <article>. */}
